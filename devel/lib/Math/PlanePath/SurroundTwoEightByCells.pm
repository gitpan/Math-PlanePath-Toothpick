...
package Math::PlanePath::SurroundTwoEightByCells;             
use 5.004;
use strict;
use Carp;
#use List::Util 'max';
...
sub n_to_xy {
  my ($self, $n) = @_;
  ### SurroundTwoEightByCells n_to_xy(): $n
...
sub xy_to_n {
  my ($self, $x, $y) = @_;
  ### SurroundTwoEightByCells xy_to_n(): "$x, $y"
...
sub rect_to_n_range {
  ...
  ### SurroundTwoEightByCells rect_to_n_range(): "$x1,$y1  $x2,$y2"
